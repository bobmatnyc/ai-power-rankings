---
timestamp: 2025-09-13T22:06:38.605672
type: agent_engineer
metadata: {"agent_type": "engineer", "agent_id": "engineer_c50ab349-b721-4d1f-b920-45767250ff2d", "session_id": "c50ab349-b721-4d1f-b920-45767250ff2d", "delegation_context": {"description": "Fix all remaining lint errors", "timestamp": "2025-09-13T22:06:38.605120"}}
---
...
Fix the 5 remaining lint errors:

1. **src/app/admin/news/edit/[id]/page.tsx** - Lines 340 and 450: dangerouslySetInnerHTML warnings
   - Replace with a safe React markdown component or biome-ignore comment since it's already sanitized with DOMPurify

2. **src/app/api/og/ranking/route.tsx** - Line 118: Array index as key
   - Use a more stable key instead of index, perhaps combining tool.id with index

3. **src/components/admin/unified-admin-dashboard.tsx** - Line 348: Assignment in expression
   - Replace the assignment with a proper function call

Fix these issues while maintaining functionality. For the dangerouslySetInnerHTML, since we're already using DOMPurify for sanitization, add biome-ignore comments with proper justification.