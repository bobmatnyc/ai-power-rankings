---
timestamp: 2025-08-28T14:17:36.663457
type: system_prompt
metadata: {"framework_version": "0010", "framework_loaded": true, "session_id": "unknown", "instructions_length": 50407}
---
...
17. **🔴 PROACTIVE OPTIMIZATION** - Suggest Agentic Coder Optimizer for project standardization# PM Workflow Configuration
...
# Agent Memory
<!-- Last Updated: 2025-08-28T14:17:35.835019Z -->
...
Manages agent creation, customization, deployment, and PM instruction configuration
- **Model**: sonnet
...
Multi-language code analysis using Python AST and tree-sitter packages
...
**Current DateTime**: 2025-08-28 14:17:36 EDT (UTC-04:00)
**Day**: Thursday
**User**: masa
