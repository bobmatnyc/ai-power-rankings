---
timestamp: 2025-09-15T10:29:26.997294
type: agent_engineer
metadata: {"agent_type": "engineer", "agent_id": "engineer_8320c604-19a8-4de8-baf3-f49ce97b9871", "session_id": "8320c604-19a8-4de8-baf3-f49ce97b9871", "delegation_context": {"description": "Fix error page Html import", "timestamp": "2025-09-15T10:29:26.995606"}}
---
...
Fix the error: "Error: <Html> should not be imported outside of pages/_document" 

The error is occurring when prerendering the /500 error page. In Next.js App Router, Html, Head, Body, and Main components should not be used - they're only for the Pages Router's _document.js file.

Find the error pages (404.tsx, 500.tsx, error.tsx) and remove any imports of Html, Head, Body, or Main from 'next/document'. These pages should use standard React components and Next.js App Router patterns instead.