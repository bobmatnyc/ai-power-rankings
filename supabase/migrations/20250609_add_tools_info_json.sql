-- =============================================================================
-- MIGRATION: Add JSON info column to tools table
-- Date: 2025-06-09
...
CREATE INDEX IF NOT EXISTS idx_tools_info_company ON tools ((info->>'company_name'));
...
SELECT 
    ...
    t.subcategory,
    t.status,
    t.info->>'company_name' as company_name,
...
-- =============================================================================
-- METRICS HISTORY VIEW FOR TOOLS
-- =============================================================================
