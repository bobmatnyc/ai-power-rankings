      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-xl font-bold text-white mb-4">AI Power Rankings</h2>
          ...
          <nav aria-labelledby="footer-quick-links">
            <h3 id="footer-quick-links" className="text-lg font-semibold text-white mb-4">
              Quick Links
            </h3>
          ...
          <nav aria-labelledby="footer-legal-links">
            <h3 id="footer-legal-links" className="text-lg font-semibold text-white mb-4">
              Legal
            </h3>
            <ul className="space-y-2 text-sm">
              <li>
