    ...
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#10b981' }}>{stats.verified}</div>
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#ef4444' }}>{stats.unsubscribed}</div>
              ...
              <tr key={subscriber.id} style={{ 
                ...
                <td style={{ padding: '12px' }}>
                  <span style={{
                    padding: '4px 8px',
                    backgroundColor: 
                      subscriber.status === 'verified' ? '#dcfce7' :
                      subscriber.status === 'pending' ? '#fef3c7' : '#fee2e2',
                    color: 
                      subscriber.status === 'verified' ? '#166534' :
                      subscriber.status === 'pending' ? '#92400e' : '#dc2626',
                    borderRadius: '4px',
                    fontSize: '12px'
                  }}>
                    {subscriber.status}
