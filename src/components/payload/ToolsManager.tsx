    ...
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#3b82f6' }}>{tools.length}</div>
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#10b981' }}>{categories.length}</div>
        ...
        <div style={{ 
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#f59e0b' }}>{rankings.length}</div>
