...
export const ALGORITHM_V5_WEIGHTS: RankingWeightsV5 = {
  agenticCapability: 0.30,       // 30% - Primary factor (reduced from 35%)
...
export class RankingEngineV5 {
  ...
  static getAlgorithmInfo() {
    return {
      ...
      description: 'Balanced approach with 30% agentic capability, 15% innovation, and minimum 5% for all factors',
