...
import { SiteSettings, SiteSettingsData } from './schemas';
...
const siteSettingsSchema = {
  type: 'object',
  required: ['id', 'site_name', 'description', 'contact_email', 'algorithm_version', 'created_at', 'updated_at'],
  properties: {
...
export class SiteSettingsRepository extends BaseRepository<SiteSettingsData> {
   ...
   */
  async updateSettings(updates: Partial<Omit<SiteSettings, 'id' | 'created_at'>>): Promise<SiteSettings> {
