    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "AI tools are ranked using our proprietary Algorithm v6.0, which evaluates 8 key factors: Agentic Capability, Innovation, Technical Performance, Developer Adoption, Market Traction, Business Sentiment, Development Velocity, and Platform Resilience.",
        },
      },
      {
        "@type": "Question",
...
export function generateToolReviewSchema(tool: ToolSchemaData, baseUrl: string) {
  ...
  return {
    ...
    reviewBody: `${tool.name} ranks #${tool.rank} in our comprehensive AI tool rankings, with a score of ${tool.score}/100 based on our Algorithm v6.0 evaluation.`,
  };
}
