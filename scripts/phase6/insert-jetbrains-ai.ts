...
/**
 * Phase 6: JetBrains AI Assistant - INSERT new tool
 * Creates JetBrains AI Assistant tool in database (doesn't exist yet)
 */
...
async function insertJetBrainsAI() {
  const db = getDb();
  if (db === null) {
  ...
  try {
    console.log('🔄 Inserting JetBrains AI Assistant into database...\n');
    ...
    console.log('✅ JetBrains AI Assistant inserted successfully!\n');
    console.log('📊 Inserted fields:');
    console.log('   - Slug: jetbrains-ai-assistant');
    console.log('   - Name: JetBrains AI Assistant');
    ...
    console.error('❌ Error inserting JetBrains AI Assistant:', error);
    throw error;
  }
}
