...
const translations: Record<string, Record<string, string>> = {
  de: {
    ...
    "newsletter.verify.success.description":
      "Vielen Dank für die Bestätigung Ihrer E-Mail-Adresse. Sie erhalten nun unseren monatlichen Newsletter.",
    ...
    "newsletter.unsubscribe.success.description":
      "Sie wurden vom AI Power Ranking Newsletter abgemeldet. Es tut uns leid, Sie gehen zu sehen!",
    "newsletter.unsubscribe.error.title": "Abmeldefehler",
    "newsletter.unsubscribe.errors.unsubscribeFailed":
      "Wir konnten Ihre Abmeldeanfrage nicht verarbeiten. Bitte versuchen Sie es später erneut.",
  ...
  fr: {
    ...
    "home.recent.description":
      "Derniers développements et sorties de fonctionnalités des meilleurs outils IA",
    "home.recent.viewAllButton": "Voir toutes les actualités",

    // Footer
    "footer.description":
      "La source faisant autorité pour les classements et analyses d'outils de codage IA",
    ...
    "newsletter.verify.success.description":
      "Merci d'avoir confirmé votre adresse email. Vous recevrez maintenant notre newsletter mensuelle.",
    ...
    // Newsletter unsubscribe
    "newsletter.unsubscribe.success.description":
      "Vous avez été désinscrit de la newsletter AI Power Ranking. Nous sommes désolés de vous voir partir !",
    "newsletter.unsubscribe.error.title": "Erreur de désinscription",
    "newsletter.unsubscribe.errors.unsubscribeFailed":
      "Nous n'avons pas pu traiter votre demande de désinscription. Veuillez réessayer plus tard.",
    "newsletter.unsubscribe.errors.default":
      "Une erreur inattendue s'est produite. Veuillez réessayer plus tard.",
  },
  ...
  ko: {
    ...
    // Newsletter unsubscribe
    "newsletter.unsubscribe.success.description":
      "AI Power Ranking 뉴스레터 구독이 취소되었습니다. 떠나시게 되어 아쉽습니다!",
    "newsletter.unsubscribe.errors.unsubscribeFailed":
      "구독 취소 요청을 처리할 수 없습니다. 나중에 다시 시도해주세요.",
    "newsletter.unsubscribe.errors.default":
